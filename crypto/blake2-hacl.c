...
int hacl_blake2b_update_generic(struct shash_desc *desc, const u8 *in,
                                unsigned int inlen)
{
...
EXPORT_SYMBOL(hacl_blake2b_update_generic);

int hacl_blake2b_final_generic(struct shash_desc *desc, u8 *out)
{
        struct Hacl_Streaming_Blake2_blake2b_32_state_s *sctx =
                shash_desc_ctx(desc);
...
EXPORT_SYMBOL(hacl_blake2b_final_generic);
...
#define BLAKE2B_ALG(name, driver_name, digest_size)                         \
        {                                                                   \
                ...
                .init = hacl_blake2b_init,                                  \
                .update = hacl_blake2b_update_generic,                      \
                .final = hacl_blake2b_final_generic,                        \
                .descsize = sizeof(                                         \
                        struct Hacl_Streaming_Blake2_blake2b_32_state_s),   \
        }

static struct shash_alg blake2_generic_hacl_algs[] = {
        BLAKE2B_ALG("blake2b-160", "blake2b-160-generic-hacl",
                    BLAKE2B_160_HASH_SIZE),
        BLAKE2B_ALG("blake2b-256", "blake2b-256-generic-hacl",
                    BLAKE2B_256_HASH_SIZE),
        BLAKE2B_ALG("blake2b-384", "blake2b-384-generic-hacl",
                    BLAKE2B_384_HASH_SIZE),
        BLAKE2B_ALG("blake2b-512", "blake2b-512-generic-hacl",
                    BLAKE2B_512_HASH_SIZE),
};

static int __init blake2_generic_hacl_mod_init(void)
{
        return crypto_register_shashes(blake2_generic_hacl_algs,
                                       ARRAY_SIZE(blake2_generic_hacl_algs));
}

static void __exit blake2_generic_hacl_mod_fini(void)
{
        crypto_unregister_shashes(blake2_generic_hacl_algs,
                                  ARRAY_SIZE(blake2_generic_hacl_algs));
}

subsys_initcall(blake2_generic_hacl_mod_init);
module_exit(blake2_generic_hacl_mod_fini);

MODULE_LICENSE("GPLv2 or MIT");
MODULE_DESCRIPTION(
        "Formally Verified Generic BLAKE2 Secure Hash Algorithm from HACL*");

MODULE_ALIAS_CRYPTO("blake2b-160");
MODULE_ALIAS_CRYPTO("blake2b-160-generic-hacl");
MODULE_ALIAS_CRYPTO("blake2b-256");
MODULE_ALIAS_CRYPTO("blake2b-256-generic-hacl");
MODULE_ALIAS_CRYPTO("blake2b-384");
MODULE_ALIAS_CRYPTO("blake2b-384-generic-hacl");
MODULE_ALIAS_CRYPTO("blake2b-512");
MODULE_ALIAS_CRYPTO("blake2b-512-generic-hacl");
...
int hacl_blake2s_update_generic(struct shash_desc *desc, const u8 *in,
                                unsigned int inlen)
{
...
EXPORT_SYMBOL(hacl_blake2s_update_generic);

int hacl_blake2s_final_generic(struct shash_desc *desc, u8 *out)
{
        struct Hacl_Streaming_Blake2_blake2s_32_state_s *sctx =
                shash_desc_ctx(desc);
...
EXPORT_SYMBOL(hacl_blake2s_final_generic);
...
#define BLAKE2S_ALG(name, driver_name, digest_size)                         \
        {                                                                   \
                ...
                .base.cra_module = THIS_MODULE, .digestsize = digest_size,  \
                .init = hacl_blake2s_init,                                  \
                .update = hacl_blake2s_update_generic,                      \
                .final = hacl_blake2s_final_generic,                        \
                .descsize = sizeof(                                         \
                        struct Hacl_Streaming_Blake2_blake2s_32_state_s),   \
        }

static struct shash_alg blake2s_generic_hacl_algs[] = {
        BLAKE2S_ALG("blake2s-160", "blake2s-160-generic-hacl", 20),
        BLAKE2S_ALG("blake2s-256", "blake2s-256-generic-hacl", 32),
};

static int __init blake2s_generic_hacl_mod_init(void)
{
        return crypto_register_shashes(blake2s_generic_hacl_algs,
                                       ARRAY_SIZE(blake2s_generic_hacl_algs));
}

static void __exit blake2s_generic_hacl_mod_fini(void)
{
        crypto_unregister_shashes(blake2s_generic_hacl_algs,
                                  ARRAY_SIZE(blake2s_generic_hacl_algs));
}

subsys_initcall(blake2s_generic_hacl_mod_init);
module_exit(blake2s_generic_hacl_mod_fini);
...
MODULE_ALIAS_CRYPTO("blake2s-160-generic-hacl");
MODULE_ALIAS_CRYPTO("blake2s-256");
MODULE_ALIAS_CRYPTO("blake2s-256-generic-hacl");
